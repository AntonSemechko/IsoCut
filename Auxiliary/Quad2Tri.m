...
% Convert a quad surface mesh to a triangular surface mesh so that the 
% minimum aspect ratio of the resulting triangles is maximized. 
%
% INPUT:
%   - F     : M-by-4 array of quad face vertex connectivities
%   - V     : N-by-3 array of mesh vertex coordiantes
%
% OUTPUT:
